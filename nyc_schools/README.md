...
A simple, responsive wb mapping application using [Leaflet](http://leafletjs.com/), [Bootstrap](http://getbootstrap.com/),  and [typeahead.js](http://twitter.github.io/typeahead.js/).

### Demo:
http://xtrudio.github.io/nyc_schools_map/

### Features:
* Fullscreen mobile-friendly map  with responsive Navbar and modal placeholders
